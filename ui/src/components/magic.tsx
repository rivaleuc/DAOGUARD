...
export function AuroraText({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <span
      className={cn(
        'bg-[linear-gradient(135deg,#34d399_0%,#22d3ee_25%,#a78bfa_50%,#34d399_75%,#22d3ee_100%)] bg-[length:200%_auto] bg-clip-text text-transparent animate-[gradient-x_6s_linear_infinite]',
        className,
      )}
    >
      {children}
